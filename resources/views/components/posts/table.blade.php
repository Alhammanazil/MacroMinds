...
<section class="p-3 antialiased sm:p-5">
    <h2 class="pl-4 mb-4 text-xl font-semibold text-gray-900 dark:text-white">Post by: {{ Auth::user()->name }}</h2>
    <div class="max-w-screen-xl px-4">
        <div class="relative overflow-hidden bg-white border dark:bg-gray-800 sm:rounded-lg">
