...
<div class="relative max-w-4xl p-4 bg-white border rounded-lg dark:bg-gray-800 sm:p-5">
    ...
    <form action="/dashboard/{{ $post->slug }}" method="POST" id="post-form">
        ...
        <div class="mb-4">
            ...
            <textarea name="content" id="content" rows="4" style="display: none;" placeholder="Write post content here">{{ old('content', $post->content) }}</textarea>
...
@push('script')
    ...
    <script>
        ...
        // Set initial content from the post
